...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col rounded-xl bg-white py-6 2xl:py-10 max-w-2xl m-2 w-full justify-center items-center ${!isPending ? "opacity-60 pointer-events-none" : "opacity-95"} `}
      >
        <header className="font-semibold text-lg sm:text-2xl xl:text-3xl py-2 ">
